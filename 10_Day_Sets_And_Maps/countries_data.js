...
console.log(`There are ${languagesSet.size} languages in the countries array.`);
...
function mostSpokenLanguages(countries, count) {
  ...
  for (const lang of languagesSet) {
    const specificLang = languages.filter((specLang) => specLang === lang);
    languagesCount.push({ [lang]: specificLang.length });
  }

  const sortedLanguagesCount = languagesCount.sort((a, b) => {
    const aValue = Object.values(a)[0];
    const bValue = Object.values(b)[0];
    return bValue - aValue;
  });
  return sortedLanguagesCount.slice(0, count);
}
